...
struct Config {
    ...
    size_t get_rdma_buffer_size_hint(int64_t hidden_bytes, int num_ranks) const {
        ...
        num_bytes += num_channels * num_rdma_ranks * num_max_rdma_chunked_recv_tokens * ht::get_source_meta_bytes() * 2;
...
inline size_t
get_low_latency_buffer_size_hint(int num_max_dispatch_tokens_per_rank,
                                 int hidden,
                                 int num_ranks,
                                 int num_experts) {
